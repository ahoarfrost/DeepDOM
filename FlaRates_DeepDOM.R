#DeepDOM labeling scheme: stn#-d#-substrate-rep-t#
#e.g. stn7-d0-lam-x-t3 or stn4-d5-chon-1-t0

#acct for ignoreFLA and regular using addend in masterlist
#add change to zero as part processing? 
...
#FLAMaster is the main sheet where you will record all your rates info; it also contains other metadata you want too
Master <- "FLAMasterEmpty_DeepDOM.csv"
#output file want output to be written to
outputMaster <- "FLAMasterRates_DeepDOM.csv"
FLAMaster <- read.csv(Master,header=TRUE,row.names=1)
